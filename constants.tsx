...
export const ORIGINAL_NAV_ITEMS: { id: View, title: string, description: string, icon: React.FC<any> }[] = [ { id: 'who-we-are', title: 'Who Why & Need', description: 'About BWGA', icon: ManualIcon }, { id: 'opportunities', title: 'Data Hub', description: 'Live Intelligence', icon: OpportunitiesIcon }, { id: 'report-entry', title: 'BWGA Report System/T&C', description: 'Inquire & Report', icon: ReportIcon }, { id: 'compliance', title: 'Compliance', description: 'Data & Security', icon: ComplianceIcon }, ];
